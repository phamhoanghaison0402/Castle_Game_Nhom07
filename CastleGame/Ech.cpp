...
Ech::Ech(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::ECH_OBJECT;
...
void Ech::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void Ech::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void Ech::UpdateObjectState(GameTime *gameTime)
{
