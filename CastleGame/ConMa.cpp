...
Ma::Ma(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
...
void Ma::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void Ma::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void Ma::UpdateObjectState(GameTime *gameTime)
{
