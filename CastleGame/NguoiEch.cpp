...
NguoiEch::NguoiEch(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::NGUOIECH_OBJECT;
...
void NguoiEch::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void NguoiEch::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void NguoiEch::UpdateObjectState(GameTime *gameTime)
{
