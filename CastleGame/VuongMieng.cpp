...
VuongMieng::VuongMieng(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::VUONGMIENG_OBJECT;
...
void VuongMieng::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void VuongMieng::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void VuongMieng::UpdateObjectState(GameTime *gameTime)
{
