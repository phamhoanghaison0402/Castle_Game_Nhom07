...
TuiTienXanh::TuiTienXanh(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::TUITIEN_XANH_OBJECT;
...
void TuiTienXanh::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void TuiTienXanh::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void TuiTienXanh::UpdateObjectState(GameTime *gameTime)
{
