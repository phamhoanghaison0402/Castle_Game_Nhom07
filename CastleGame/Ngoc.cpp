...
Ngoc::Ngoc(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::NGOC_OBJECT;
...
void Ngoc::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void Ngoc::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void Ngoc::UpdateObjectState(GameTime *gameTime)
{
