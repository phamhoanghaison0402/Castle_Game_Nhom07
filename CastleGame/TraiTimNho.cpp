...
TraiTimNho::TraiTimNho(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::TRAITIM_NHO_OBJECT;
...
void TraiTimNho::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void TraiTimNho::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void TraiTimNho::UpdateObjectState(GameTime *gameTime)
{
