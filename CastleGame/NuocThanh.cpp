...
NuocThanh::NuocThanh(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::NUOCTHANH_OBJECT;
...
void NuocThanh::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void NuocThanh::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void NuocThanh::UpdateObjectState(GameTime *gameTime)
{
