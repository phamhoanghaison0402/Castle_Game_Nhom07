...
BinhVang::BinhVang(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::BINHVANG_OBJECT;
...
void BinhVang::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void BinhVang::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void BinhVang::UpdateObjectState(GameTime *gameTime)
{
