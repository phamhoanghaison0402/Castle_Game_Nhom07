...
TuiTienTrang::TuiTienTrang(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::TUITIEN_TRANG_OBJECT;
...
void TuiTienTrang::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void TuiTienTrang::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void TuiTienTrang::UpdateObjectState(GameTime *gameTime)
{
