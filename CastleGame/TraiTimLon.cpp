...
TraiTimLon::TraiTimLon(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::TRAITIM_LON_OBJECT;
...
void TraiTimLon::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void TraiTimLon::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void TraiTimLon::UpdateObjectState(GameTime *gameTime)
{
