...
DayChuyen::DayChuyen(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::DAYCHUYEN_OBJECT;
...
void DayChuyen::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void DayChuyen::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void DayChuyen::UpdateObjectState(GameTime *gameTime)
{
