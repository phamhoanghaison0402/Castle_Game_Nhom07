...
public:
	string _Filename;
private:
	SaveData _data, _updateData;
	
	list<Node *> _ListNodes, _Update_ListNodes;
	list<GameObject *> _ListGameObjects, _Update_ListGameObjects;
	map<Node *, list<GameObject *> *> _ObjectsInNodes, _Update_ObjectsInNodes;
public:
