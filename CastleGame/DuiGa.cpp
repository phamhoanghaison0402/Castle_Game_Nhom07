...
DuiGa::DuiGa(DXTexture *pTexture, D3DXVECTOR2 position, Direction direction, D3DXVECTOR2 velocity)
	: Enemy(pTexture, position, direction, velocity)
{
	...
	this->_OType = EObjectName::DUIGA_OBJECT;
...
void DuiGa::Update(GameTime *gameTime)
{
	DynamicObject::Update(gameTime);
}

void DuiGa::Draw(DXGame *pDXGame, Camera *pCamera)
{
	LivingObject::Draw(pDXGame, pCamera);
}

void DuiGa::UpdateObjectState(GameTime *gameTime)
{
